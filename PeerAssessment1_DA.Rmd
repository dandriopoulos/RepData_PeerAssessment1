...
```{r question 2, echo=TRUE, message=FALSE}
library(dplyr)
...
```{r question 3, echo=TRUE, message=FALSE}
library(ggplot2)
...
```{r question 4, echo=TRUE, message=FALSE}
library(ggplot2)
df.old<-df
...
```
### Question 4
``` {r question 4.4, echo = TRUE, message = FALSE}
